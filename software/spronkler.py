                ...
                try:
                    ...
                    # add a schedule
                        ...
                        if isinstance(conflict_result, self.MsgACK):
                            ...
                            msg.schedule['nextrun'] = int(datetime.datetime.strptime(msg.schedule['start_time'], self.dateformat).replace(year=datetime.datetime.now().year).timestamp()) - 365 * 24 * 60 * 60
